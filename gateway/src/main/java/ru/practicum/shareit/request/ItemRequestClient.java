...
public class ItemRequestClient extends BaseClient {
    ...
    public ResponseEntity<Object> createRequest(ShortItemRequestDto itemRequestData, Long userId) {
    ...
    public ResponseEntity<Object> getRequestsByPages(Long userId, Long from, Long size) {
